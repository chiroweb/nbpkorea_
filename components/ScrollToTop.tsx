    ...
    >
      ...
      >
        ...
        <text
          ...
          fontWeight="500"
        >
          <textPath href="#textCircle" startOffset="75%" textAnchor="middle">NBPKOREA</textPath>
        </text>
        <text
          fill="#C05010"
          fontSize="10.5"
          ...
          fontWeight="500"
        >
          <textPath href="#textCircle" startOffset="25%" textAnchor="middle">NBPKOREA</textPath>
        </text>
        <text
          fill="#C05010"
          fontSize="7"
          fontFamily="Roboto, sans-serif"
        >
          <textPath href="#textCircle" startOffset="0%" textAnchor="middle">·</textPath>
        </text>
        <text
          fill="#C05010"
          fontSize="7"
          fontFamily="Roboto, sans-serif"
        >
          <textPath href="#textCircle" startOffset="50%" textAnchor="middle">·</textPath>
        </text>
      </svg>
