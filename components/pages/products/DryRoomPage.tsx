...
const content = {
  en: {
    title: "Dry Room AHU",
    heroTags: ["Dew Point Below -40°C", "Ultra-Low Humidity", "Battery Process Specialized", "Precision Humidity Control"],
    applications: [
      "Electrode Manufacturing",
      "Cell Assembly Process",
      "Active Material & Electrolyte Handling",
      "Secondary Battery Pilot Line",
      "Battery Component Storage",
      "Ultra-Low Humidity Process Room",
    ],
    processFlow: [
      "Outdoor Air Intake",
    ...
    processHighlight: ["Dehumidification", "Dew Point Control"],
    processEnd: "Dry Room Supply",
    features: [
      "Optimized for maintaining ultra-low humidity required in secondary battery manufacturing",
      "HVAC and dehumidification design considering dew point operation below -40°C",
      "Contributes to quality stability and yield improvement for moisture-sensitive processes",
      "Precision temperature/humidity control logic adaptable to process load variations",
      "Gas combustion-based heat source for fast response and energy efficiency",
      "Integrated package configuration including dehumidifier, reheater, and blower",
      "Customizable airflow, dew point, and room pressure considering line expansion plans",
      "End-to-end support: design, fabrication, installation, TAB, and maintenance",
    ],
    capabilityCards: [
      { title: "Humidity Control", value: "Ultra-Low Dew Point", description: "Dehumidification capacity and reheat conditions are designed together to match the target dew point." },
      { title: "Process Stability", value: "Moisture Risk Reduction", description: "Focused on reducing variability in moisture-sensitive materials and assembly processes." },
      { title: "System Design", value: "Integrated AHU + Dehumidification", description: "HVAC, dehumidification, heat source, and controls are reviewed as an integrated system." },
      { title: "Field Response", value: "Custom Engineering", description: "Custom specifications proposed based on line scale, outdoor conditions, process heat, and room pressure." },
    ],
    coreModules: [
      { title: "Adsorption Dehumidifier", description: "Achieves dehumidification performance through rotor or dehumidification modules for low dew point air formation." },
      { title: "Pre-Treatment Coil", description: "Adjusts pre-cooling/pre-heating conditions based on outdoor air state to reduce the main dehumidifier load." },
      { title: "Reheat Section", description: "Corrects supply air temperature after dehumidification to match process and work environment requirements." },
      { title: "Local Low-Humidity Zone", description: "Separate design of dry booths or concentrated dehumidification zones to reduce overall operating energy." },
    ],
    designPoints: [
      { title: "Target Dew Point", description: "Dehumidification capacity and regeneration conditions set based on line-specific target dew point and tolerance." },
      { title: "Outdoor Air Load", description: "Dehumidification system capacity calculated considering seasonal outdoor moisture load and infiltration." },
      { title: "Energy Savings", description: "Operating cost reduction reviewed through local dehumidification, regeneration heat optimization, and airflow control." },
      { title: "Scalability", description: "Modular expansion structure considered for line expansion or battery process changes." },
    ],
    specGuide: [
      { label: "Target Condition", value: "Ultra-Low Humidity / Low Dew Point" },
      { label: "Industry", value: "Secondary Battery / Solid-State" },
      { label: "Control Items", value: "Dew Point / Temp / RH / DP" },
      { label: "Configuration", value: "Dry Room / Dry Booth" },
    ],
    bodyText: "Moisture management across electrode, assembly, and storage processes is directly linked to battery quality. NBPKOREA Dry Room AHU is designed with integrated dehumidification, reheat, and airflow control to maintain stable ultra-low humidity even under varying outdoor conditions and process loads.",
    flowNote: "Designed to adjust dehumidification, reheat, and recirculation control together, considering outdoor air conditions and process load variations.",
    specNote: "A Dry Room AHU is not just a dehumidifier — it is an ultra-low humidity production infrastructure combining pre-treatment, main dehumidification, reheat, and room pressure management. Designed to balance low dew point performance with operating energy for battery manufacturing environments.",
    ctaTitle: "Considering a Dry Room AHU?",
    ctaDesc: "We will propose specifications matched to your target dew point, airflow, room pressure, and process conditions.",
    floatingLabel: "View Dry Room AHU Case Studies",
    imgAlt: "Dry Room AHU",
  },
  ko: {
    title: "드라이룸 공조기",
    heroTags: ["노점온도 -40℃ 이하", "초저습 환경", "2차전지 공정 특화", "정밀 습도 제어"],
    applications: [
      "전극 제조 공정",
      "셀 조립 공정",
      "활물질·전해질 취급 구역",
    ...
    capabilityCards: [
      { title: "Humidity Control", value: "Ultra-Low Dew Point", description: "공정 목표 노점에 맞춰 제습량과 재가열 조건을 함께 설계합니다." },
      { title: "Process Stability", value: "Moisture Risk Reduction", description: "수분 반응에 민감한 소재와 조립 공정의 변동성을 낮추는 데 집중합니다." },
      { title: "System Design", value: "Integrated AHU + Dehumidification", description: "공조와 제습, 열원, 제어를 분리하지 않고 통합적으로 검토합니다." },
      { title: "Field Response", value: "Custom Engineering", description: "라인 규모, 외기 조건, 공정 발열, 실압 조건에 맞춘 맞춤 사양을 제안합니다." },
    ],
    coreModules: [
    ...
    bodyText: "전극, 조립, 보관 공정 전반에서 수분 관리는 배터리 품질과 직결됩니다. 엔비피코리아 드라이룸 공조기는 외기 조건과 공정 부하 변화에도 안정적인 극저습 상태를 유지하도록 제습, 재가열, 풍량 제어를 통합적으로 설계합니다.",
    flowNote: "외기 상태와 공정 부하 변동을 고려해 제습, 재가열, 순환풍 제어를 함께 조정하는 구조를 기준으로 설계합니다.",
    specNote: "드라이룸 공조기는 단순 제습기가 아니라 전처리, 본 제습, 재가열, 실압 관리가 결합된 초저습 생산 인프라입니다. 배터리 제조 환경에 맞춰 저노점 성능과 운영 에너지의 균형을 함께 검토합니다.",
    ctaTitle: "드라이룸 공조기 도입을 검토 중이신가요?",
    ctaDesc: "목표 노점, 처리 풍량, 실압, 공정 조건에 맞는 사양을 제안해 드립니다.",
    floatingLabel: "드라이룸 공조기 적용 사례 보러가기",
    imgAlt: "드라이룸 공조기",
  },
};
