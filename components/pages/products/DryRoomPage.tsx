...
export default function DryRoomPage() {
  ...
  return (
    <><ProductPlaceholderPage
      ...
      titleKo="Dry Room 공조 시스템"
      titleEn="Dry Room HVAC System"
      ...
      tags={["2차전지", "저녹스", "초저습"]}
      ctaTitleKey="Dry Room 시스템 도입을 검토 중이신가요?"
    ...
    <FloatingCaseLink category="hvac" tag="Dry Room" label="Dry Room 적용 사례 보러가기" /></>
  );
}
