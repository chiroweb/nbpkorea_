  ...
  return (
    ...
    >
      ...
      <section className="px-6 md:px-12 py-12 bg-[#F2F4F7] border-y border-[#D4DAE2]">
        <div className="max-w-7xl mx-auto">
          <p className="text-[13px] tracking-[0.2em] uppercase text-[#8B95A1] mb-6">작동 원리 — Indirect Firing Principle</p>
          ...
          <p className="text-[14px] text-[#8B95A1] mt-4">연소 배기가스는 외부로 배출 — 가열 공기는 청정 상태 유지</p>
        </div>
      </section>
              ...
              <tbody>
                {specs.map((row) => (
                  ...
                  >
                    ...
                    <td className="py-3.5 px-4 text-[#8B95A1]">{row.volume}</td>
                    <td className="py-3.5 px-4 text-[#8B95A1]">{row.cmh}</td>
                    <td className="py-3.5 px-4 text-[#8B95A1]">{row.maxPressure}</td>
                    <td className="py-3.5 px-4 text-[#8B95A1]">{row.size}</td>
                    <td className="py-3.5 px-4 text-[#8B95A1]">{row.weight}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section className="px-6 md:px-12 py-16 border-t border-[#D4DAE2]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-sm text-[#8B95A1]">{t("combustion.nkIdgh.ctaDesc")}</p>
          </div>
