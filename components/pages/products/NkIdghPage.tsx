...
const content = {
  en: {
    ...
    heroDesc1: "An indirect-fired industrial gas heater that uses a heat exchanger to completely separate combustion gases from the supply air. Since combustion exhaust does not mix with heated air, it is optimized for environments requiring clean air such as paint booths, food processing, clean rooms, and pharmaceutical facilities.",
    heroDesc2: "Available in 4 models from 100,000 to 1,000,000 Kcal/h, featuring stainless steel heat exchangers for superior corrosion and heat resistance. Compatible with LNG, LPG, and city gas, with modulating control for precise supply temperature management.",
    heroTags: ["100,000~1,000,000 Kcal/h", "Indirect Heat Exchange", "Clean Air Supply", "Modulating Control"],
    applications: [
      "Automotive Paint Booth",
      "Ship Block Paint Workshop",
      "Food Processing & Drying",
      "Clean Room & Semiconductor Process",
      "Pharmaceutical Production Facility",
      "Printing & Coating Process",
      "Agricultural & Marine Product Drying",
      "Wood & Plywood Processing",
      "Textile & Leather Drying",
      "Precision Paint Facility",
      "Cold Storage & Warehouse",
      "Other Clean Heating Facilities",
    ],
    processTitle: "Operating Principle — Indirect Firing Principle",
    processSteps: [
      { label: "Gas Supply\nLNG/LPG", bg: "#DCE2E8", text: "#2d2a28" },
      { label: "→", isArrow: true },
      { label: "Burner Combustion\n(Inside Chamber)", bg: "#C05010", text: "#fff" },
      { label: "→", isArrow: true },
      { label: "Heat Exchanger\n(Exhaust/Air Separation)", bg: "#E8A060", text: "#fff" },
      { label: "→", isArrow: true },
      { label: "Clean Hot Air\n(Clean Hot Air)", bg: "#2d2a28", text: "#fff" },
    ],
    processNote: "Combustion exhaust is discharged externally — heated air remains clean",
    features: [
      "Clean indirect heating via heat exchanger",
      "Combustion exhaust separated from supply air — maintains clean air",
      "Optimized for environments requiring clean air: paint booths, clean rooms, food processing, etc.",
      "4-model lineup from 400,000 to 1,000,000 Kcal/h",
      "Compatible with LNG / LPG / city gas",
      "Modulating control for precise temperature regulation",
      "Stainless steel heat exchanger for corrosion and heat resistance",
      "Hazardous gas separation structure for worker safety",
      "Built-in auto-ignition and auto-reignition safety system",
      "Overheat protection and flame detection safety devices as standard",
      "MIDCO International (USA) technology partnership",
      "One-stop custom design, fabrication, installation, and after-service",
    ],
    specHeaders: ["MODEL", "Capacity (Kcal/h)", "Fuel", "Airflow (m³/min)", "CMH", "Max Pressure (mmAq)", "Size (m)", "Weight (kg)"],
    specs: [
      { model: "NK-IDGH-40",  capacity: "400,000",   fuel: "LNG/LPG/Ethylene", volume: "200", cmh: "12,000", maxPressure: "250", size: "W1.5 × L2.97 × H2.92", weight: "3,500", control: "Modulating" },
      { model: "NK-IDGH-60",  capacity: "600,000",   fuel: "LNG/LPG/Ethylene", volume: "250", cmh: "15,000", maxPressure: "300", size: "W1.5 × L2.97 × H2.92", weight: "3,700", control: "Modulating" },
  ...
  ko: {
    title: "간접식 가스히터",
    heroDesc1: "열교환기(Heat Exchanger)를 사용하여 연소 가스와 공급 공기를 완전히 분리하는 간접 가열 방식의 산업용 가스히터입니다. 연소 배기가스가 가열 공기와 섞이지 않으므로 도장 부스, 식품 가공, 클린룸, 제약 시설 등 청정한 공기가 반드시 필요한 현장에 최적화되어 있습니다.",
    heroDesc2: "100,000 Kcal/h부터 1,000,000 Kcal/h까지 4개 모델로 구성되며, 스테인리스 열교환기를 적용하여 내식성과 내열성이 뛰어납니다. LNG·LPG·도시가스를 모두 사용할 수 있으며, 비례제어 방식으로 공급 온도를 정밀하게 관리합니다.",
    heroTags: ["100,000~1,000,000 Kcal/h", "간접 열교환 방식", "청정 공기 공급", "비례제어"],
    applications: [
      "자동차 도장 부스",
      "선박 블록 도장 작업장",
      "식품 가공·건조 공정",
    ...
    processTitle: "작동 원리 — Indirect Firing Principle",
    processSteps: [
      { label: "가스 공급\nLNG/LPG", bg: "#DCE2E8", text: "#2d2a28" },
      { label: "→", isArrow: true },
    ...
    processNote: "연소 배기가스는 외부로 배출 — 가열 공기는 청정 상태 유지",
    features: [
      ...
      <section className="px-6 md:px-12 py-16">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transition-all duration-1000 delay-300 ${heroInView ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}`}>
            <div className="relative aspect-[5/4] md:aspect-[4/3] overflow-hidden bg-white border border-[#C05010]/30">
              <Image
