...
const content = {
  en: {
    heroTitle: "Regenerative Catalytic Oxidizer\n(RCO)",
    heroDesc1: "RCO is a new combustion technology that adds a catalyst to a direct combustion incinerator using regenerative media as a heat recovery medium. This technology uses a burner for initial startup and heating, then passes organic solvents and organic odors through a catalyst bed capable of low-temperature oxidation, treating them at low temperatures (250~450°C). This greatly reduces nitrogen oxide (NOx) generation from low-temperature, low-concentration combustion while recovering combustion heat through regenerative media to prevent air pollution and using waste heat as a heat source for production processes, significantly enhancing energy savings.",
    heroDesc2: "With a maximum treatment efficiency of over 99% and a maximum heat recovery efficiency of 95%, this technology uses recovered heat and applies catalysts for low-temperature oxidation treatment, resulting in very high energy savings and applicability to various industrial processes.",
    heroTags: ["Treatment Efficiency 99%+", "Heat Recovery 95%+", "Low-temp Oxidation 250~450°C", "Med/Small Volume Optimized"],
    applications: [
    ...
    features: [
      ...
      "NOx suppression from low-temperature, low-concentration combustion",
      ...
      "Catalyst and regenerative hybrid system",
      "Optimized for high-concentration VOCs in medium/small air volumes",
      "Various layouts possible depending on site installation conditions",
      "Eco-friendly system with very high energy savings",
      "Eco-friendly equipment with no secondary pollutants",
    ],
    floatingLabel: "View RCO Case Studies",
    imgAlt: "NK-RCO Regenerative Catalytic Oxidizer",
  },
  ko: {
    heroTitle: "축열식촉매연소산화장치\n(RCO)",
    heroDesc1: "RCO는 축열재를 열회수 매체로 사용하는 직접연소식 소각로에 촉매를 추가로 적용한 신연소 기술입니다. 이 기술은 버너를 이용해 초기 기동해 승온한 후, 유기용제나 유기성 악취를 저온에서 산화 가능한 촉매층을 통과시켜 낮은 온도(250~450°C)에서 처리하여 저온, 저농도의 연소로부터 질소산화물(NOx) 생성을 크게 줄이고 연소열을 축열재로 회수하여 대기오염을 방지하고 폐열을 생산공정의 열원으로 사용하여 에너지 절감 효과를 크게 제고할 수 있는 신연소 기술입니다.",
    heroDesc2: "최대 99% 이상의 처리효율을 가지며, 최대 95% 열회수효율이 특징인 기술로써 회수열을 사용하고 촉매를 적용해 저온에서 산화 처리가 가능해 에너지절감 효과가 매우 높고 다양한 산업공정에 적용이 가능합니다.",
    heroTags: ["처리효율 99%+", "열회수율 95%+", "저온산화 250~450°C", "중·소풍량 최적"],
    applications: [
    ...
    floatingLabel: "RCO 적용 사례 보러가기",
    imgAlt: "NK-RCO 축열식촉매연소산화장치",
  },
};
...
export default function NkRcoPage() {
  ...
  return (
    ...
    >
      <FloatingCaseLink category="environment" tag="RCO" label={c.floatingLabel} />
      {/* 공통 제품 네비게이션 */}
