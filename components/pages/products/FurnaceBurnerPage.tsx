...
const content = {
  en: {
    ...
    appImages: [
      { src: `${S3}/images/burner/cases/furnace-case-new-1.jpg`, alt: "Furnace Burner Application Example 1" },
      { src: `${S3}/images/burner/furnace-burner-main.jpg`, alt: "Furnace Burner Application Example 2" },
      { src: `${S3}/images/burner/cases/furnace-case-new-3.jpg`, alt: "Furnace Burner Application Example 3" },
      { src: `${S3}/images/burner/cases/furnace-case-new-4.jpg`, alt: "Furnace Burner Application Example 4" },
      { src: `${S3}/images/burner/cases/furnace-burner-case-2.jpg`, alt: "Furnace Burner Application Example 5" },
      { src: `${S3}/images/burner/cases/furnace-burner-case-3.jpg`, alt: "Furnace Burner Application Example 6" },
    ],
  ...
  ko: {
    ...
    appImages: [
      { src: `${S3}/images/burner/cases/furnace-case-new-1.jpg`, alt: "로용 버너 적용 예시 1" },
      { src: `${S3}/images/burner/furnace-burner-main.jpg`, alt: "로용 버너 적용 예시 2" },
      { src: `${S3}/images/burner/cases/furnace-case-new-3.jpg`, alt: "로용 버너 적용 예시 3" },
      { src: `${S3}/images/burner/cases/furnace-case-new-4.jpg`, alt: "로용 버너 적용 예시 4" },
      { src: `${S3}/images/burner/cases/furnace-burner-case-2.jpg`, alt: "로용 버너 적용 예시 5" },
      { src: `${S3}/images/burner/cases/furnace-burner-case-3.jpg`, alt: "로용 버너 적용 예시 6" },
    ],
    imgAlt: "로용 버너",
