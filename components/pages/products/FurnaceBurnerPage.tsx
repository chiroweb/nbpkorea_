...
const content = {
  en: {
    ...
    appImages: [
      { src: "/images/burner/cases/furnace-burner-case-1.jpg", alt: "Furnace Burner Application Example 1" },
  ...
  ko: {
    ...
    appImages: [
      { src: "/images/burner/cases/furnace-burner-case-1.jpg", alt: "로용 버너 적용 예시 1" },
