...
const content = {
  en: {
    ...
    appImages: [
      { src: `${S3}/images/burner/furnace-burner-main.jpg`, alt: "Furnace Burner Application Example 1" },
      { src: `${S3}/images/burner/fpb/Process-Burner-2.jpeg`, alt: "Furnace Burner Application Example 2" },
      { src: `${S3}/images/burner/fpb/dual-fuel-burners-40199-6408931.jpg`, alt: "Furnace Burner Application Example 3" },
    ],
