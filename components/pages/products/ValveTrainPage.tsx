...
const content = {
  en: {
    ...
    appImages: [
      ...
      { src: `${S3}/images/burner/cases/valve-train-case-4.jpg`, alt: "Valve Train Application Example 4" },
    ],
    imgAlt: "Valve Train",
  ...
  ko: {
    ...
    appImages: [
      ...
      { src: `${S3}/images/burner/cases/valve-train-case-4.jpg`, alt: "밸브트레인 적용 예시 4" },
    ],
    imgAlt: "밸브트레인",
