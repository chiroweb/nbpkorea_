...
const products = [
  ...
  { title: "FPB 버너", subtitle: "Forced Pre-mix Burner", desc: "강제 예혼합 방식으로 완전 연소를 실현하는 고효율 산업용 버너.", image: `${S3}/images/burner/fpb/gas-burners-40199-6233087.jpg`, href: "/products/burner/fpb-burner" },
