          ...
          >
            <div className="border-t border-[#2d2a28]/20">
              {[
                ...
                >
                  <span className="text-[13px] tracking-[0.06em] uppercase text-[#5C6470] block mb-1">
                    {item.label}
                  </span>
                  <span className="text-base tracking-[0.05em] text-[#2d2a28] block">{item.value}</span>
                  {item.sub && <span className="text-xs text-[#5C6470]">{item.sub}</span>}
                </div>
              ))}
            </div>
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              {inquiryTypes.map((type, index) => (
                ...
                >
                  <span className="text-[13px] tracking-[0.06em] uppercase text-[#5C6470] group-hover:text-[#C8D0DA]">
                    {type.subtitle}
                  </span>
                  <span className="text-sm tracking-[0.08em] font-medium">{type.title}</span>
                  <span className="text-[14px] text-[#5C6470] group-hover:text-[#C8D0DA] mt-auto">
                    {type.desc}
                  </span>
