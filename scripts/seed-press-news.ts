...
const pressArticles = [
  ...
  },
  {
    ...
    is_published: true,
    content: [
      { type: "p", text: "엔비피코리아(대표 최혁순)가 메탈버너를 적용한 강제혼합식 가스버너를 국내 최초로 개발해 한국가스안전공사로부터 설계단계검사 합격 판정을 받았다." },
      { type: "p", text: "메탈버너는 금속 섬유로 제작된 다공성 연소면에서 연소가 이루어져 균일한 화염 분포와 낮은 NOx 배출을 동시에 실현한다. 기존 버너 대비 에너지 효율이 30% 이상 높다." },
  ...
  },
  {
    ...
    is_published: true,
    content: [
      { type: "p", text: "엔비피코리아(대표 최혁순)가 고효율 메탈버너를 적용한 프리미엄 멀티 화덕을 개발해 보급에 나섰다." },
      { type: "p", text: "이 화덕은 피자, 바비큐, 생선구이 등 다양한 요리를 빠르게 조리할 수 있으며, 메탈버너 특유의 균일한 복사열로 음식을 고르게 익힐 수 있다." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "엔비피코리아는 미국 MIDCO International과의 기술 제휴를 통해 글로벌 수준의 연소 기술을 국내 산업 현장에 보급하고, 동시에 자체 메탈버너 기술을 개발해 특허 포트폴리오를 쌓아 왔다." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "이번 허가 취득으로 엔비피코리아는 메탈버너, 가스히터 등 자체 개발 가스 기기를 자사 브랜드로 생산·판매할 수 있는 법적 기반을 확보하게 됐다." },
      { type: "p", text: "출처: 가스신문" },
    ],
  },
  {
  ...
  },
  {
    ...
    is_published: true,
    content: [
      { type: "p", text: "엔비피코리아(대표 최혁순)가 자사 메탈버너를 적용한 가스비 절감형 친환경 멀티화덕을 출시했다." },
