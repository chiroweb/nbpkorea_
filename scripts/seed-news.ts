...
const news = [
  ...
  {
    slug: "website-remodeling-review-chiroweb",
    category: "회사 소식",
    date: "2025.04.16",
    title: "홈페이지 리모델링 후기 — 배포 2주 만에 기술 문의 3건, 견적 요청 4건",
    excerpt: "치로웹디자인의 SEO·AEO·GEO 총설계로 홈페이지를 전면 리뉴얼한 후, 배포 직후부터 실질적인 문의가 쏟아지고 있습니다. 2016년 구축 대비 비용은 낮추고 퀄리티는 비교할 수 없을 만큼 올라간 경험을 공유합니다.",
    image_url: `${S3}/images/about/hq-front.jpg`,
    read_time: "7분",
    is_published: true,
    content: [
      { type: "h2", text: "10년 된 홈페이지, 더 이상 버틸 수 없었다" },
      { type: "p", text: "NBPKOREA는 2006년 창업 이래 산업용 연소설비, 환경설비, 공조설비, 버너 사업을 영위해 온 기술 중심 기업입니다. 그런데 정작 우리 회사의 '첫인상'이라 할 수 있는 홈페이지는 2016년에 만들어진 채 거의 손대지 못한 상태였습니다. 제품 라인업은 계속 늘어나고, 특허와 수상 실적도 쌓이고, 해외 파트너십도 확대됐는데 홈페이지에는 그 어떤 것도 반영되지 않고 있었습니다." },
      { type: "p", text: "솔직히 말하면, 홈페이지가 영업에 도움이 된다는 생각을 해본 적이 없었습니다. 우리 업종 특성상 수주는 기존 거래처 관계나 입찰을 통해 이루어지니까요. 그런데 최근 몇 년간 신규 문의가 눈에 띄게 줄었고, 경쟁사들은 하나둘 웹사이트를 리뉴얼하면서 검색 상위에 노출되기 시작했습니다. 위기감이 들었습니다." },
      { type: "h2", text: "치로웹디자인을 만나다" },
      { type: "p", text: "여러 웹에이전시를 비교하다가 치로웹디자인(chiroweb.co.kr)을 알게 됐습니다. 처음에는 반신반의했습니다. SEO(검색엔진최적화), AEO(AI엔진최적화), GEO(생성형AI최적화)까지 총설계한다는 말이 와닿지 않았거든요. 그런데 미팅에서 우리 업종의 검색 트렌드, 경쟁사 노출 현황, 키워드별 검색량 데이터를 직접 보여주면서 설명하는 걸 듣고 생각이 완전히 바뀌었습니다." },
      { type: "p", text: "치로웹디자인은 단순히 예쁜 홈페이지를 만드는 데서 그치지 않았습니다. 우리 회사의 사업 구조를 이해하고, 각 사업부(환경·연소·공조·버너)별로 검색 유입 경로를 설계했습니다. 제품 페이지 하나하나에 기술 키워드를 자연스럽게 녹여 넣고, 구조화된 데이터(Schema Markup)를 적용해 검색엔진과 AI가 우리 콘텐츠를 정확히 이해할 수 있도록 만들었습니다." },
      { type: "h2", text: "배포 2주, 믿기 어려운 결과" },
      { type: "p", text: "홈페이지를 배포한 지 정확히 2주 만에 기술 문의 3건, 견적 요청 4건이 들어왔습니다. 10년 가까이 홈페이지를 운영하면서 웹을 통한 직접 문의는 1년에 한두 건도 없던 회사였습니다. 그런데 리뉴얼 후 단 2주 만에 7건의 실질적 문의가 들어온 겁니다. 문의 내용도 구체적이었습니다. 'RTO 처리 풍량 20만 CMH 기준 견적 요청', '메탈버너 도장 라인 적용 기술 미팅 요청' 같은 식이었습니다. 홈페이지를 통해 우리 기술력을 충분히 파악한 후 연락하는 것이 느껴졌습니다." },
      { type: "p", text: "가장 놀라운 건 비용이었습니다. 2016년에 만든 기존 홈페이지보다 견적이 훨씬 저렴했습니다. 그런데 퀄리티는 비교 자체가 되지 않습니다. 반응형 디자인, 다국어(한/영) 지원, 제품별 상세 페이지, 적용 사례 갤러리, 뉴스 시스템, 관리자 페이지까지 — 2016년 버전에서는 상상도 못 했던 기능들이 모두 포함되어 있습니다." },
      { type: "h2", text: "SEO·AEO·GEO, 이렇게 중요한 줄 몰랐다" },
      { type: "p", text: "솔직히 SEO라는 단어도 잘 몰랐습니다. AEO, GEO는 처음 들어봤고요. 그런데 실제로 경험해 보니 이것이 산업재 B2B 영업의 판도를 바꿀 수 있는 요소라는 걸 체감했습니다. 구글에서 'RTO 제작업체', '산업용 가스히터'를 검색하면 우리 회사가 상위에 노출됩니다. ChatGPT나 Gemini 같은 AI에게 국내 RTO 제조사를 물어보면 NBPKOREA가 언급됩니다. 이런 변화가 단순히 홈페이지를 예쁘게 만든 결과가 아니라, SEO·AEO·GEO를 체계적으로 설계한 결과라는 걸 이제는 알고 있습니다." },
      { type: "h2", text: "앞으로의 계획" },
      { type: "p", text: "이번 경험을 계기로, 홈페이지를 단순한 회사 소개 페이지가 아니라 영업과 기술 마케팅의 핵심 채널로 운영하기로 했습니다. 신규 제품 출시, 기술 제휴, 적용 사례, 인증 취득 등 회사의 주요 활동을 꾸준히 블로그 형태로 작성해 나갈 계획입니다. 콘텐츠가 쌓일수록 검색 노출도 늘어나고, AI가 우리 회사를 더 잘 이해하게 된다는 걸 알게 됐으니까요." },
      { type: "p", text: "산업재 B2B 기업이라 홈페이지가 필요 없다고 생각하시는 분들이 많을 겁니다. 저도 그랬습니다. 하지만 지금은 확실히 말할 수 있습니다 — 제대로 만든 홈페이지는 24시간 일하는 영업사원입니다. 홈페이지 리뉴얼을 고민하고 계시다면, 치로웹디자인(chiroweb.co.kr)에 상담해 보시길 권합니다." },
    ],
  },
];
