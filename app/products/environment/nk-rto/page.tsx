...
export default function NkRtoPage() {
  ...
  return (
    <SubpageLayout
      title="NK-RTO"
      subtitle="축열식연소산화장치 — Regenerative Thermal Oxidizer"
      breadcrumb={[
    ...
    >
      ...
      <section className="px-6 md:px-12 py-12 bg-[#F2F4F7] border-y border-[#D4DAE2]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[14px] text-[#8B95A1] mt-4 tracking-[0.05em]">열 재이용 (Heat Recovery via Ceramic Regenerator)</p>
        </div>
      </section>
      ...
      <section className="px-6 md:px-12 py-16 border-t border-[#D4DAE2]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <h3 className="text-lg tracking-[0.08em] font-light text-[#2d2a28] mb-2">NK-RTO 도입을 검토 중이신가요?</h3>
