...
const specs = [
  ...
  { model: "NKRCO-100", airflow: 100, heatInput: "500,000", power: 22, length: "4,060", width: "2,300", height: "3,700" },
  { model: "NKRCO-150", airflow: 150, heatInput: "600,000", power: 37, length: "5,060", width: "2,300", height: "3,700" },
  { model: "NKRCO-200", airflow: 200, heatInput: "800,000", power: 45, length: "7,200", width: "2,300", height: "3,700" },
  { model: "NKRCO-300", airflow: 300, heatInput: "1,250,000", power: 75, length: "7,200", width: "2,200", height: "3,700" },
];
...
export default function NkRcoPage() {
  ...
  return (
    <SubpageLayout
      title="NK-RCO"
      subtitle="축열식촉매연소산화장치 — Regenerative Catalytic Oxidizer"
      breadcrumb={[
    ...
    >
      ...
      <section className="px-6 md:px-12 py-12 bg-[#F2F4F7] border-y border-[#D4DAE2]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[14px] text-[#8B95A1] mt-4 tracking-[0.05em]">열 재이용 (Catalyst + Regenerator Hybrid)</p>
        </div>
      </section>
      ...
      <section className="px-6 md:px-12 py-16 border-t border-[#D4DAE2]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <h3 className="text-lg tracking-[0.08em] font-light text-[#2d2a28] mb-2">NK-RCO 도입을 검토 중이신가요?</h3>
