...
const specs = [
  { model: "차량 도장 건조기", capacity: "1,250,000", fuel: "LNG/LPG/도시가스", install: "고정형 (Fixed Type)", control: "PLC 비례제어" },
];
...
export default function PaintDryerPage() {
  ...
  return (
    <SubpageLayout
      title="차량 도장 건조기"
      subtitle="Paint Dryer System — 자동차 도장 부스 전용 열풍 건조 시스템"
      breadcrumb={[
        { label: "제품/솔루션", href: "/products" },
        { label: "연소설비", href: "/products?tab=combustion" },
        { label: "차량 도장 건조기", href: "/products/combustion/paint-dryer" },
      ]}
    >
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-sm text-[#8B95A1] leading-[2] mb-6">
              NBP KOREA 차량 도장 건조기는 자동차 도장 부스 및 선박 도장 라인에 특화된 고출력 열풍 건조 시스템입니다. 1,250,000 Kcal/h의 고출력으로 대형 도장 부스를 단시간 내에 목표 온도로 승온하고, PLC 비례제어 방식으로 부스 내 온도를 균일하게 유지합니다.
            </p>
      ...
      <section className="px-6 md:px-12 py-16 border-t border-[#D4DAE2]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <h3 className="text-lg tracking-[0.08em] font-light text-[#2d2a28] mb-2">차량 도장 건조기 도입을 검토 중이신가요?</h3>
            <p className="text-sm text-[#8B95A1]">도장 부스 규모와 요구 온도에 맞는 최적 사양을 제안해 드립니다.</p>
          </div>
