...
export default function LineBurnerPage() {
  ...
  return (
    <SubpageLayout
      title="라인버너"
      subtitle="Line Burner — 연속 공정 라인 전용 산업용 버너"
      breadcrumb={[
    ...
    >
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transition-all duration-1000 delay-300 ${heroInView ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}`}>
            <div className="relative aspect-[4/3] overflow-hidden bg-[#DCE2E8]">
              <Image
                src={`${S3}/images/burner/line-burner.png`}
                alt="라인버너"
      ...
      <section className="px-6 md:px-12 py-16 border-t border-[#D4DAE2]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <h3 className="text-lg tracking-[0.08em] font-light text-[#2d2a28] mb-2">라인버너 도입을 검토 중이신가요?</h3>
            <p className="text-sm text-[#8B95A1]">공정 라인 길이·요구 온도·연료 조건에 맞는 최적 사양을 제안해 드립니다.</p>
          </div>
